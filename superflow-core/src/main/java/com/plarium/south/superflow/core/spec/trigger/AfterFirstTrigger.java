...
public class AfterFirstTrigger extends BaseTrigger<Trigger> {
    public static final String TYPE = "trigger/after/first";
    ...
    protected Trigger create() {
        return AfterFirst.of(fetchTriggers(triggers));
    }
}
