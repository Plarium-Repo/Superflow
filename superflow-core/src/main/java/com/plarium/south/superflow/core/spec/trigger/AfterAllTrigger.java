...
public class AfterAllTrigger extends BaseTrigger<Trigger> {
    public static final String TYPE = "trigger/after/all";
    ...
    protected Trigger create() {
        return AfterAll.of(fetchTriggers(triggers));
    }
}
